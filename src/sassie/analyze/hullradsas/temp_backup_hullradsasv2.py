...
class ShrakeRupley:
    ...
    def __init__(self, probe_radius=0.85, n_points=10, radii_dict=None):
...
#   print('check total hyll volume = ',check_tot_hull_vol)
...
#   vol_hyd_hull_rot = vol_hull + vol_shell_wat_rot
    ...
    return s,Dt,Dr,vbar_prot,Rht,ffo_hyd_P,prot_mol_mass,Ro,Rhr,int_vis,a_b_ratio, \
           Ft,AnhRg,HydRg,Dmax,tauC,asphr,int_vis,ks,AA,NA,GL,DT,useNumpy
...
#mvars:    run_name, pdbfile, ofile
    ...
    def epilogue(self):
        ...
        log = self.log
        mvars = self.module_variables
        divars = self.hullradsas_variables
        pgui = self.run_utils.print_gui
        wait = self.wait
    ...
    #   write_pdb(model_array, basename + '_model.pdb')
        ...
        s,Dt,Dr,vbar_prot,Rht,ffo_hyd_P,M,Ro,Rhr,int_vis,a_b_ratio,Ft,AnhRg,HydRg,Dmax,tauC, \
           asphr,int_vis,ks,AA,NA,GL,DT,useNumpy \
