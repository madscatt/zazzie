function [x,Resnorm,FVAL,EXITFLAG,OUTPUT,LAMBDA,JACOB] = lsqnonlin1(FUN,x,LB,UB,options,varargin)
...
caller = 'lsqnonlin1'; YDATA = [];
[x,Resnorm,FVAL,EXITFLAG,OUTPUT,LAMBDA,JACOB] = ...
   lsqncommon1(FUN,x,YDATA,LB,UB,options,defaultopt,caller,...
