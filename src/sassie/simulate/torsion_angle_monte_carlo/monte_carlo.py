...
import sassie.simulate.torsion_angle_monte_carlo.overlap as overlap
...
#       11/29/2022      --      python 3.X support              :       jc
#
# LC     1         2         3         4         5         6         7
...
class simulation():
    ...
    def setup_groups(self):
        ...
        for group_number in range(mvars.number_of_flexible_regions):
            ...
            this_group_molecule = system.Molecule(0)
            this_group_flexible_molecule = system.Molecule(0)
            this_group_post_molecule = system.Molecule(0)
    ...
    def initialization(self):
        ...
        self.full_molecule = system.Molecule(0)
