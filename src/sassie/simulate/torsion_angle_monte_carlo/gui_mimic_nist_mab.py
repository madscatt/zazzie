...
runname = 'run_1'
dcdfile = 'run_1.dcd'
pdbfile = '../../../developer_files_for_testing/torsion_angle_monte_carlo/full_nist_mab.pdb'
psffile = '../../../developer_files_for_testing/torsion_angle_monte_carlo/full_nist_mab.psf'
