...
$Id: gui_mimic_antibody.py 3040 2016-03-01 20:05:14Z schowell $
'''
...
basis_string_array = []
basis_string_array.append('segname FIXH and (resid > 211 and resid < 216)')
basis_string_array.append('segname FIXK and (resid > 211 and resid < 216)')
...
post_basis_string_array.append('(segname FIXH and resid <= 211) or segname FIXL')
post_basis_string_array.append('(segname FIXK and resid <= 211) or segname FIXM')
