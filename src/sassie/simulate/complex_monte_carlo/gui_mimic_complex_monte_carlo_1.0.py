...
#import nmer_dihedral as nmer_dihedral
...
#    self.confile = 'rna_protein_constraints2.txt'
    ...
    self.parmfilepath=sasconfig._bin_path+'toppar'  #not currently used
...
#    print 'variables: ', self.variables
    ...
    nmer_dihedral.dihedralgenerate(self.variables,self.psegvariables,txtQueue)
