...
import sassie.calculate.gui_mimic_sld_mol as gui_mimic_sld_mol
...
*****************************
    ...
    no deut regions         no deut regions     single deut region  single deut region  mult deut regions   mult deut regions 
...
*****************************
    runtype = 1; sldfit = 1
*****************************
    This mode is not recommended since z0 and A0 will be different for each structure.
    Two cases are tested since all other combinations are tested above.
    Both cases are tested for completion only.
    
    reference PDB           reference PDB       
    input DCD               input PDB           
    no deut regions         no deut regions     
                            sldoffset     


  
    *xon is tested for no deut regions only 
    '''
...
#        print 'lines: ', lines
    ...
    def test_1(self):
        '''
        test runtype=0, sldfit = 0, input DCD, no deut regions
        '''
        ...
        correct_outfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_dcd_none', self.outputfile), 'r').readlines()
        corroutz = []
        corrouta = []
        corrouterr = []
        ...
        self.assert_list_almost_equal(corrouterr, outerr, self.precision)        
        ...
        corr_avgfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_dcd_none', 'average_sld.txt'), 'r').readlines()
        corravgz = []
        corravgsld = []
    ...
    def test_2(self):
        '''
        test runtype=0, sldfit = 0, input DCD, single deut region
        '''
        ...
        for i in range(len(outfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                outerr.append(float(lin[3]))
        correct_outfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_dcd_one', self.outputfile), 'r').readlines()
        corroutz = []
        corrouta = []
        corrouterr = []
        for i in range(len(correct_outfile)):
        ...
        for i in xrange(len(avgfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                avgsld.append(float(lin[1]))        
        corr_avgfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_dcd_one', 'average_sld.txt'), 'r').readlines()
        corravgz = []
        corravgsld = []
        for i in xrange(len(corr_avgfile)):
            lin = string.split(corr_avgfile[i])    
    ...
    def test_3(self):
        '''
        test runtype=0, sldfit = 0, input DCD, mult deut regions
        '''
        ...
        for i in range(len(outfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                outerr.append(float(lin[3]))
        correct_outfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_dcd_mult', self.outputfile), 'r').readlines()
        corroutz = []
        corrouta = []
        corrouterr = []
        for i in range(len(correct_outfile)):
        ...
        for i in xrange(len(avgfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                avgsld.append(float(lin[1]))        
        corr_avgfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_dcd_mult', 'average_sld.txt'), 'r').readlines()
        corravgz = []
        corravgsld = []
        for i in xrange(len(corr_avgfile)):
            lin = string.split(corr_avgfile[i])    
    ...
    def test_4(self):
        '''
        test runtype=0, sldfit = 0, input DCD, no deut regions, sldoffset
        '''
        ...
        for i in range(len(outfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                outerr.append(float(lin[3]))
        correct_outfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_dcd_none_sldoffset', self.outputfile), 'r').readlines()
        corroutz = []
        corrouta = []
        corrouterr = []
        for i in range(len(correct_outfile)):
        ...
        for i in xrange(len(avgfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                avgsld.append(float(lin[1]))        
        corr_avgfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_dcd_none_sldoffset', 'average_sld.txt'), 'r').readlines()
        corravgz = []
        corravgsld = []
        for i in xrange(len(corr_avgfile)):
            lin = string.split(corr_avgfile[i])    
    ...
    def test_5(self):
        '''
        test runtype=0, sldfit = 0, input DCD, one deut region, sldoffset
        '''
        ...
        for i in range(len(outfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                outerr.append(float(lin[3]))
        correct_outfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_dcd_one_sldoffset', self.outputfile), 'r').readlines()
        corroutz = []
        corrouta = []
        corrouterr = []
        for i in range(len(correct_outfile)):
        ...
        for i in xrange(len(avgfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                avgsld.append(float(lin[1]))        
        corr_avgfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_dcd_one_sldoffset', 'average_sld.txt'), 'r').readlines()
        corravgz = []
        corravgsld = []
        for i in xrange(len(corr_avgfile)):
            lin = string.split(corr_avgfile[i])    
    ...
    def test_6(self):
        '''
        test runtype=0, sldfit = 0, input DCD, mult deut regions, sldoffset
        '''
        ...
        for i in range(len(outfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                outerr.append(float(lin[3]))
        correct_outfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_dcd_mult_sldoffset', self.outputfile), 'r').readlines()
        corroutz = []
        corrouta = []
        corrouterr = []
        for i in range(len(correct_outfile)):
        ...
        for i in xrange(len(avgfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                avgsld.append(float(lin[1]))        
        corr_avgfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_dcd_mult_sldoffset', 'average_sld.txt'), 'r').readlines()
        corravgz = []
        corravgsld = []
        for i in xrange(len(corr_avgfile)):
            lin = string.split(corr_avgfile[i])    
    ...
    def test_7(self):
        '''
        test runtype=0, sldfit = 0, input PDB, no deut regions
        '''
        ...
        for i in range(len(outfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                outerr.append(float(lin[3]))
        correct_outfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_pdb_none', self.outputfile), 'r').readlines()
        corroutz = []
        corrouta = []
        corrouterr = []
        for i in range(len(correct_outfile)):
        ...
        for i in xrange(len(avgfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                avgsld.append(float(lin[1]))        
        corr_avgfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_pdb_none', 'average_sld.txt'), 'r').readlines()
        corravgz = []
        corravgsld = []
        for i in xrange(len(corr_avgfile)):
            lin = string.split(corr_avgfile[i])    
    ...
    def test_8(self):
        '''
        test runtype=0, sldfit = 0, input PDB, single deut region
        '''
        ...
        for i in range(len(outfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                outerr.append(float(lin[3]))
        correct_outfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_pdb_one', self.outputfile), 'r').readlines()
        corroutz = []
        corrouta = []
        corrouterr = []
        for i in range(len(correct_outfile)):
        ...
        for i in xrange(len(avgfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                avgsld.append(float(lin[1]))        
        corr_avgfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_pdb_one', 'average_sld.txt'), 'r').readlines()
        corravgz = []
        corravgsld = []
        for i in xrange(len(corr_avgfile)):
            lin = string.split(corr_avgfile[i])    
    ...
    def test_9(self):
        '''
        test runtype=0, sldfit = 0, input PDB, mult deut regions
        '''
        ...
        for i in range(len(outfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                outerr.append(float(lin[3]))
        correct_outfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_pdb_mult', self.outputfile), 'r').readlines()
        corroutz = []
        corrouta = []
        corrouterr = []
        for i in range(len(correct_outfile)):
        ...
        for i in xrange(len(avgfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                avgsld.append(float(lin[1]))        
        corr_avgfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_pdb_mult', 'average_sld.txt'), 'r').readlines()
        corravgz = []
        corravgsld = []
        for i in xrange(len(corr_avgfile)):
            lin = string.split(corr_avgfile[i])    
    ...
    def test_10(self):
        '''
        test runtype=0, sldfit = 0, input PDB, no deut regions, sldoffset
        '''
        ...
        for i in range(len(outfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                outerr.append(float(lin[3]))
        correct_outfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_pdb_none_sldoffset', self.outputfile), 'r').readlines()
        corroutz = []
        corrouta = []
        corrouterr = []
        for i in range(len(correct_outfile)):
        ...
        for i in xrange(len(avgfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                avgsld.append(float(lin[1]))        
        corr_avgfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_pdb_none_sldoffset', 'average_sld.txt'), 'r').readlines()
        corravgz = []
        corravgsld = []
        for i in xrange(len(corr_avgfile)):
            lin = string.split(corr_avgfile[i])    
    ...
    def test_11(self):
        '''
        test runtype=0, sldfit = 0, input PDB, one deut region, sldoffset
        '''
        ...
        for i in range(len(outfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                outerr.append(float(lin[3]))
        correct_outfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_pdb_one_sldoffset', self.outputfile), 'r').readlines()
        corroutz = []
        corrouta = []
        corrouterr = []
        for i in range(len(correct_outfile)):
        ...
        for i in xrange(len(avgfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                avgsld.append(float(lin[1]))        
        corr_avgfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_pdb_one_sldoffset', 'average_sld.txt'), 'r').readlines()
        corravgz = []
        corravgsld = []
        for i in xrange(len(corr_avgfile)):
            lin = string.split(corr_avgfile[i])    
    ...
    def test_12(self):
        '''
        test runtype=0, sldfit = 0, input PDB, mult deut regions, sldoffset
        '''
        ...
        for i in range(len(outfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                outerr.append(float(lin[3]))
        correct_outfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_pdb_mult_sldoffset', self.outputfile), 'r').readlines()
        corroutz = []
        corrouta = []
        corrouterr = []
        for i in range(len(correct_outfile)):
        ...
        for i in xrange(len(avgfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                avgsld.append(float(lin[1]))        
        corr_avgfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_pdb_mult_sldoffset', 'average_sld.txt'), 'r').readlines()
        corravgz = []
        corravgsld = []
        for i in xrange(len(corr_avgfile)):
            lin = string.split(corr_avgfile[i])    
    ...
    def test_13(self):
        '''
        test runtype=0, sldfit = 0, input DCD, no deut regions, xon
        '''
        ...
        for i in range(len(outfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                outerr.append(float(lin[3]))
        correct_outfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_dcd_none_xon', self.outputfile), 'r').readlines()
        corroutz = []
        corrouta = []
        corrouterr = []
        for i in range(len(correct_outfile)):
        ...
        for i in xrange(len(avgfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                avgsld.append(float(lin[1]))        
        corr_avgfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_dcd_none_xon', 'average_sld.txt'), 'r').readlines()
        corravgz = []
        corravgsld = []
        for i in xrange(len(corr_avgfile)):
            lin = string.split(corr_avgfile[i])    
    ...
    def test_14(self):
        '''
        test runtype=0, sldfit = 0, input PDB, no deut regions, xon
        '''
        ...
        for i in range(len(outfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                outerr.append(float(lin[3]))
        correct_outfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_pdb_none_xon', self.outputfile), 'r').readlines()
        corroutz = []
        corrouta = []
        corrouterr = []
        for i in range(len(correct_outfile)):
        ...
        for i in xrange(len(avgfile)):
            ...
            if(lin[0][0] != "#" and len(lin) >= 2):
                ...
                avgsld.append(float(lin[1]))        
        corr_avgfile = open(os.path.join(
            module_data_path, self.runname, self.module, '00_pdb_none_xon', 'average_sld.txt'), 'r').readlines()
        corravgz = []
        corravgsld = []
        for i in xrange(len(corr_avgfile)):
            lin = string.split(corr_avgfile[i])    
