...
#import gui_mimic_em_to_sans as gui_mimic_v
...
module_data_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', '..', 'data', 'calculate', 'em_to_sans') + os.path.sep
...
class Test_Em_To_Sans(MockerTestCase):
...
**************************
    ...
    def test_1(self):
        ...
        gui_mimic_em_to_sans.run_module(self)
