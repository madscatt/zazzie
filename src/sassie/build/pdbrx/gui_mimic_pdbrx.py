...
#pdbfile = 'testing/data/small_altloc.pdb'
#pdbfile = 'testing/data/small_two_chains.pdb'
#pdbfile = 'testing/data/small_two_chains_no_gap.pdb'
#pdbfile = 'run_0/pdbrx/small_charmm.pdb'
#pdbfile = 'testing/data/p.pdb'
#pdbfile = 'testing/data/636.pdb'
#pdbfile = '3rki.pdb'
