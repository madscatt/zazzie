...
def user_variables(self, **kwargs):
    ...
    self.runname = 'run_0'
    self.inpath = './'
    self.pdbmol1 = os.path.join(self.inpath, 'hiv1_gag.pdb')
    self.pdbmol2 = os.path.join(self.inpath, 'hiv1_gag.pdb')
#    self.infile = os.path.join(self.inpath, 'hiv1_gag.pdb')
    self.infile = os.path.join(self.inpath, 'hiv1_gag_20_frames.dcd')
