...
#
# script modified by David W. Wright for usage in PDB Rx
#
# DATA  : 2016-02-11
# REV   : 2
# REQUIREMENTS: numpy, PyRosetta, extract_coords_pose
...
def kabsch_alignment( pose1, pose2 , pose1sel = [], pose2sel =[] ):
    """
    kabash_alignment performs the Kabsch alignment algorithm upon the alpha-carbons of two selections.
    ...
    DWW: Output now provides just pose2 aligned to pose1
    ...
    @return aligned_pose: Contents of pose2 aligned to pose1
    """	
    ...
    # DWW edit - move this onto target pose
    stsel2 = stsel2 + COM1
