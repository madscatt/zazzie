...
if __name__=="__main__":
	...
	prdf_n = int(cutoff_distance/prdf_spacing)+1;
	...
	# run it
	prdf.construct_prdf(solute_atom_types, solute_atom_coors, solvent_atom_types, solvent_atom_coors, solute_atom_surf_mask, xmin, ymin, zmin, cube_length, nx, ny, nz, prdf_spacing, prdf_n, cutoff_distance)
