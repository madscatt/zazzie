...
class CleanCommand(Command):
    ...
    def run(self):
        ...
        os.system('rm -vrf ./cudaSascalc.egg-info')
        os.system('rm -vrf ./cudaSascalc.so')
...
# extension module
sascalc_api = Extension(name="sascalc_api",
                     sources=['sascalc_library_extension.cpp',
                              './extensions/src/cudaKernel_GV.cu',
                              './extensions/src/cudaKernel_Debye.cu',
                              './extensions/src/cudaKernel_DebyePBC.cu',
                              './extensions/src/wrapperCudaKernel.cu',
                              './extensions/src/cudaGV.cpp',
                              './extensions/src/cudaDebye.cpp',
                              './extensions/src/cudaDebyePBC.cpp',
