...
$Id: gui_mimic_iso_peptide.py 3040 2016-03-01 20:05:14Z schowell $
'''
...
runname = 'run_0'
dcdfile = 'run_0.dcd'
pdbfile = '../../../developer_files_for_testing/torsion_angle_monte_carlo/new_ub.pdb'
psffile = '../../../developer_files_for_testing/torsion_angle_monte_carlo/new_ub.psf'
...
basis_string_array = []
basis_string_array.append('segname UB1 and resid 76 or segname UB2 and resid 48') ## @NOTE the first selection needs to be C-terminal for isopeptide
delta_theta_array = '30.0'
rotation_type_array = ['isopeptide_bond_torsion']
#rotation_direction_array = ['forward']
#post_basis_string_array = ['(segname UB2 and resid<48) or (segname UB2 and resid>48)']
rotation_direction_array = ['backward']
post_basis_string_array = ['(segname UB1 and resid<76) or (segname UB1 and resid>76)']
overlap_basis = 'heavy'
