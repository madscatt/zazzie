...
# data is a list of dictionaries, each representing a plot for one item in 'rescaled_scattering_data' or 'calculated_scattering_data'
    data = []
    for i in range(len(json_object['fraction_d2o'])):
        ...
        data.append(
            {
                "x": json_object['q_values'],
                "y": json_object['calculated_scattering_data'][i],
                "xaxis": "x",
                "yaxis": "y",
                "type": "scatter",
                "mode": "lines",
                "name": str(json_object['fraction_d2o'][i]) + " calculated",
...
#    print("data: ", data)
    ...
    lineplot2 = {
        ...
        "layout": {
            ...
            "title": {
                "text": "Rescaled and Calculated Scattering Data",
                "y": 0.9,
                "x": 0.47,
            },
            "hovermode": "x",
...
if __name__ == "__main__":
    ...
    lineplot2 = decomposition_plots(json_filename)
#    print(lineplot2)
# this JSON file can be pasted into the GenApp advanced tutorial plotly test utility
    open("decomposition_plot2_for_genapp.json", "w").write(
        json.dumps(lineplot2, indent=2))
