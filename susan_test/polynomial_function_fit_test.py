...
#    reduced_chi_squared = chi_squared/float((n-nDisregarded)-(order+1))
    ...
    try: reduced_chi_squared = chi_squared/float((n-nDisregarded)-(order+1))
    except ZeroDivisionError as e: reduced_chi_squared = chi_squared/1            
