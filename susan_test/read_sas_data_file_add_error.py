...
# NOTE:  the passed variables can become mcavars since this version of read_file is only used by multi-component analysis; we don't want to have to provide the signal-to-noise parameters when reading a data file in other modules, where experimental data is assumed.
...
#    signal_to_noise_amplitude= [400.0, 50.0]
    signal_to_noise_amplitude = [50.0, 50.0,
                                 50.0, 50.0]  # defaults CV series test
