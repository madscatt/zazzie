...
class Test_Prody_Filter(MockerTestCase):
    ...
    def test_1(self):
        ...
        '''
        self.runname = 'run_&'
        return_error = gui_mimic_prody.run_module(
    ...
    def test_4(self):
        '''
        test if number of normal modes > 0
        '''
        self.number_modes = '0'
        return_error = gui_mimic_prody.run_module(self, test_filter=True)

        ''' check for file error '''
        expected_error = ['number of normal modes needs to be greater than zero']
        assert_equals(return_error, expected_error)

    def test_5(self):
        '''
        test if number of conformations per sample > zero
        '''
        self.number_conformations_samp = '0'
        return_error = gui_mimic_prody.run_module(self, test_filter=True)

        ''' check for file error '''
        expected_error = ['number of conformations per sample needs to be greater than zero']
        assert_equals(return_error, expected_error)

    def test_6(self):
        '''
        test if number of frames to traverse per mode > zero
        '''
        self.number_steps_traverse = '0'
        return_error = gui_mimic_prody.run_module(self, test_filter=True)

        ''' check for file error '''
        expected_error = ['number of frames to traverse per mode needs to be greater than zero']
        assert_equals(return_error, expected_error)

    def test_7(self):
        '''
        test if average sampled RMSD for normal mode trajectory > zero
        '''
        self.rmsd_conformations_samp = '0'
        return_error = gui_mimic_prody.run_module(self, test_filter=True)

        ''' check for file error '''
        expected_error = ['average sampled RMSD for normal mode trajectory needs to be greater than zero']
        assert_equals(return_error, expected_error)

    def test_8(self):
        '''
        test if maximum sampled RMSD for traverse mode trajectory > zero
        '''
        self.rmsd_traverse = '0'
        return_error = gui_mimic_prody.run_module(self, test_filter=True)

        ''' check for file error '''
        expected_error = ['maximum sampled RMSD for traverse mode trajectory needs to be greater than zero']
        assert_equals(return_error, expected_error)
