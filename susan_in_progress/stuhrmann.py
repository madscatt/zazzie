...
def polynomialFit(order, X, Y, sigY, n):
    ...
    vectShape = (order+1,1)
    A = np.zeros(vectShape)
    M = np.zeros(vectShape)
...
X = np.zeros(vectShape)
Y = np.zeros(vectShape)
sigY = np.zeros(vectShape)
...
print("Rm^2: " + str(fit[2].item()) + ", " + str(math.sqrt(chi2.item()*corr.item((2,2)))))
print("alpha(dagger): " + str(fit[1].item()) + ", " + str(math.sqrt(chi2.item()*corr.item((1,1)))))
print("beta: " + str(-fit[0].item()) + ", " + str(math.sqrt(chi2.item()*corr.item((0,0)))) + "\n")

print("Extracted parameters")
print("R1^2: " + str(C[0].item()) + ", " + str(math.sqrt(DR1R2D[0].item())))
print("R2^2: " + str(C[1].item()) + ", " + str(math.sqrt(DR1R2D[1].item())))
print("D^2: " + str(C[2].item()) + ", " + str(math.sqrt(DR1R2D[2].item())))
print("R1: " + str(math.sqrt(C[0].item())) + ", " + str(0.5/math.sqrt(C[0].item())*math.sqrt(DR1R2D[0].item())))
print("R2: " + str(math.sqrt(C[1].item())) + ", " + str(0.5/math.sqrt(C[1].item())*math.sqrt(DR1R2D[1].item())))
print("D: " + str(math.sqrt(C[2].item())) + ", " + str(0.5/math.sqrt(C[2].item())*math.sqrt(DR1R2D[2].item())))
print("Rm: " + str(math.sqrt(fit[2].item())) + ", " + str(0.5/math.sqrt(fit[2].item())*math.sqrt(chi2.item()*corr.item((2,2)))))