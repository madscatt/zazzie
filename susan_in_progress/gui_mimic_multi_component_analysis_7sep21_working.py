...
import multi_component_analysis_7sep21_working as multi_component_analysis
...
import multi_component_analysis_filter_7sep21_working as multi_component_analysis_filter
...
def user_variables(self, **kwargs):
    ...
    self.output_file_name = '99_12_41f.out'
...
#at some point we will need a way to know which variables will be used for the chosen method.  Otherwise, the input filter will give an error if the string is blank.
