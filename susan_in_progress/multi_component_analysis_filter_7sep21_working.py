...
#Do we need to check the default values if read_from_file is True? The values should be initialized properly if they are read from a contrast calculator output file. A blank or missing variable will cause an error in the input filter.
